package org.vaadin.simplefiledownloader.unit;
 ...
 */
public class SimplefiledownloaderTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/SimpleFileDownloader");
    }
